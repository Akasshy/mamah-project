...
class SkriningBidan extends StatefulWidget {
  const SkriningBidan({Key? key}) : super(key: key); // Added Key? key
...
class _SkriningBidanState extends State<SkriningBidan> {
  ...
  void initState() {
    super.initState();
    _filteredChats = chats; // Initialize with all chats
    _searchController.addListener(_filterChats); // Add listener for search
  }
              ...
              decoration: InputDecoration(
                ...
                enabledBorder: OutlineInputBorder(
                  ...
                  borderSide: const BorderSide(
                    color: AppColors.inputBorderFocused, // hijau redup
                    width: 1.5,
                  ),
                ),
